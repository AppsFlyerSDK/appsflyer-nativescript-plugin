    ...
    function getApplication() {
        if (!nativeApp) {
            ...
            if (!nativeApp) {
                ...
                if (!nativeApp) {
                    var clazz = java.lang.Class.forName("android.app__.ActivityThread");
                    if (clazz) {
            ...
            if (!nativeApp) {
                throw new Error("Failed to retrieve native Android Application object. If you have a custom android.app__.Application type implemented make sure that you've called the '<application-module>.android.init' method.");
            }
        }
        return nativeApp;
    }
